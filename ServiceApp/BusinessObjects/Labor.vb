...
#Region " Private Methods "
    ...
    Private Function Insert(ByVal db As Database)
        Try
            ...
            db.Command.CommandText = "tblLabor_INSERT"
    ...
    Private Function Delete(ByVal db As Database)
        Try
            db.Command.Parameters.Clear()
            db.Command.CommandType = CommandType.StoredProcedure
            db.Command.CommandText = "tblLabor_DELETE"
    ...
    Private Function Update(ByVal db As Database)
        Try
            db.Command.Parameters.Clear()
            db.Command.CommandType = CommandType.StoredProcedure
            db.Command.CommandText = "tblLabor_UPDATE"
            db.Command.Parameters.Add("@LaborRate", SqlDbType.Money).Value = mLaborRate
            MyBase.InitializeParameters(db, MyBase.Id)
            db.ExecuteNonQuery()
            MyBase.InitializeHeaderData(db.Command)
...
#Region " Public Methods "
    ...
    Public Function GetById(ByVal Id As Integer) As Labor
        Try
            Dim db As New Database
            Dim ds As New DataSet
            db.ConnectionName = My.Settings.ConnectionName
            db.Command.CommandType = CommandType.StoredProcedure
            db.Command.CommandText = "tblLabor_GetById"
            ...
            If ds.Tables(0).Rows.Count = 1 Then
                ...
                Return Me
            Else
                Throw New Exception("GetById: Labor Not Found")
            End If
        Catch ex As Exception
            Throw ex
        End Try
