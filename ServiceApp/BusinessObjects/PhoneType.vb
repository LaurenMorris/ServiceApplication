...
#Region " Private Methods "
    ...
    Private Function Insert(ByVal db As Database)
        Try
            ...
            db.Command.CommandText = "tblPhoneType_INSERT"
    ...
    Private Function Delete(ByVal db As Database)
        Try
            db.Command.Parameters.Clear()
            db.Command.CommandType = CommandType.StoredProcedure
            db.Command.CommandText = "tblPhoneType_DELETE"
    ...
    Private Function Update(ByVal db As Database)
        Try
            db.Command.Parameters.Clear()
            db.Command.CommandType = CommandType.StoredProcedure
            db.Command.CommandText = "tblPhoneType_UPDATE"
            db.Command.Parameters.Add("@Type", SqlDbType.VarChar).Value = mType
            MyBase.InitializeParameters(db, MyBase.Id)
            db.ExecuteNonQuery()
            MyBase.InitializeHeaderData(db.Command)
...
#Region " Public Methods "
    ...
    Public Function GetById(ByVal Id As Integer) As PhoneType
        Try
            ...
            If ds.Tables(0).Rows.Count = 1 Then
                ...
                Return Me
            Else
                Throw New Exception("GetById: Phone Type Not Found")
            End If
        Catch ex As Exception
            Throw ex
        End Try
