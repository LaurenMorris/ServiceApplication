...
#Region " Public Methods "
    Public Function Save(ByVal db As Database, ByVal ManufacturerID As Integer) As ManufacturerAddress
        Try
            ...
            If result = False Then
                Throw New Exception("Manufacturer Address Save Failed")
            End If
    ...
    Public Function GetById(ByVal id As Integer) As ManufacturerAddress

        Dim database As New Database
        Dim ds As New DataSet
        database.ConnectionName = My.Settings.ConnectionName
        database.Command.CommandType = CommandType.StoredProcedure
        database.Command.CommandText = "tblManufacturerAddress_GetById"
        ...
        If ds.Tables(0).Rows.Count = 1 Then
            ...
            Return Me
        Else
            Throw New Exception("Manufacturer Address Not Found")
        End If
...
#Region " Private Methods "
    ...
    Private Function Insert(ByVal db As Database) As Boolean
        Try
            ...
            db.Command.CommandText = "tblManufacturerAddress_INSERT"
    ...
    Private Function Update(ByVal db As Database) As Boolean
        ...
        Try
            db.Command.Parameters.Clear()
            db.Command.CommandType = CommandType.StoredProcedure
            db.Command.CommandText = "tblManufacturerAddress_UPDATE"
            db.Command.Parameters.Add("@ManufacturerID", SqlDbType.Int).Value = mManufacturerID
            db.Command.Parameters.Add("@AddressTypeID", SqlDbType.Int).Value = mAddressTypeID
            db.Command.Parameters.Add("@Address", SqlDbType.VarChar).Value = mAddress
            db.Command.Parameters.Add("@City", SqlDbType.VarChar).Value = mCity
    ...
    Private Function Delete(ByVal db As Database) As Boolean
        ...
        Try
            db.Command.Parameters.Clear()
            db.Command.CommandType = CommandType.StoredProcedure
            db.Command.CommandText = "tblManufacturerAddress_DELETE"
